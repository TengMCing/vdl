...
/*-----------------------------------------------------------------------------
 |  Get (always return vector)
 ----------------------------------------------------------------------------*/

#define vdl_e_Get(...) vdlint_e_Call(vdl_e_Get_BT, vdl_vp, __VA_ARGS__)
static inline vdl_vp vdl_e_Get_BT(vdl_fr fr, const vdl_vec *const v, const int i)
{
    vdl_e_PushFrame(fr);
    ...
    if (v->type == VDL_TYPE_VP)
        return vdlint_VpAt(v, i);

    vdl_vp new_v = vdl_e_New(v->type, 1);
    new_v->len   = 1;
    ...
    switch (v->type)
    {
        case VDL_TYPE_CHAR:
        {
            vdlint_CharAt(new_v, 0) = vdlint_CharAt(v, i);
            return new_v;
        }
        case VDL_TYPE_INT:
        {
            vdlint_IntAt(new_v, 0) = vdlint_IntAt(v, i);
            return new_v;
        }
        case VDL_TYPE_DOUBLE:
        {
            vdlint_DoubleAt(new_v, 0) = vdlint_DoubleAt(v, i);
            return new_v;
        }
        case VDL_TYPE_VP:
        {
...
// static inline vdl_vp vdl_Copy_BT(vdl_fr bt, const vdl_vec *const v)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
//
//     // A new vector will be allocated
//     vdl_vp copy      = vdl_e_New(vdl_Type(v), vdl_Capacity(v));
//     vdl_Length(copy) = vdl_Length(v);
//
//     // Only the first layer of the content will be copied
//     vdl_e_Set(copy, 0, vdl_Data(v), vdl_Length(v));
...
// static inline void vdl_IAppend_BT(vdl_fr bt, vdl_vec *const v, void *const object, const int num_object)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
...
//
//     vdl_e_Reserve(v, vdl_Length(v) + num_object);
//     vdl_Length(v) += num_object;
//     vdl_e_Set(v, vdl_Length(v) - num_object, object, num_object);
//     vdl_ReturnConst();
// }
//
...
// static inline int vdl_Find_BT(vdl_fr bt, const vdl_vec *const v, void *const object)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
//     vdl_assert_NullPointer(object);
...
// static inline void vdl_IRemove_BT(vdl_fr bt, vdl_vec *const v, const int i, const int num_object)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
...
//     memmove(vdl_e_AddressOf(v, i),
//             vdl_e_AddressOf(v, i + num_object),
...
// static inline vdl_vp vdl_Remove_BT(vdl_fr bt, vdl_vec *const v, const int i, const int num_object)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
//     vdl_assert_IndexOutOfBound(v, i);
...
//     vdl_assert_ZeroObjects(num_object);
//
//     vdl_vp result = vdl_e_New(vdl_Type(v), vdl_Length(v) - num_object);
//     vdl_For_j(vdl_Length(v))
//     {
//         if (j < i || j >= i + num_object)
//             vdl_IAppend(result, vdl_e_Get(v, j), 1);
//     }
//
...
// static inline void vdl_IConcatenate_BT(vdl_fr bt, vdl_vec *const v1, vdl_vec *const v2)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v1);
//     vdl_HealthCheck(v2);
...
// static inline vdl_vp vdl_Indexing_BT(vdl_fr bt, vdl_vec *const v, vdl_vec *const indices)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
...
//
//     vdl_vp result = vdl_e_New(vdl_Type(v), vdl_Length(indices));
//     vdl_For_i(vdl_Length(indices)) vdl_IAppend(result, vdl_e_Get(v, vdl_e_GetInt(indices, i)), 1);
//     vdl_ReturnConst(result);
// }
//
// /*-----------------------------------------------------------------------------
...
// static inline vdl_vp vdl_NegIndexing_BT(vdl_fr bt, vdl_vec *const v, vdl_vec *const neg_indices)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
...
//
//     vdl_vp result = vdl_e_New(vdl_Type(v), vdl_Length(v));
//
//     vdl_For_i(vdl_Length(v))
//     {
//         int neg_i = -i;
//         if (vdl_Find(neg_indices, &neg_i) == -1)
//             vdl_IAppend(result, vdl_e_Get(v, i), 1);
//     }
//     vdl_ReturnConst(result);
// }
//
...
// static inline void vdl_Insert_BT(vdl_fr bt, vdl_vec *const v, const int i, void *const object, const int num_object)
// {
//     vdl_PushBT(bt);
//     vdl_HealthCheck(v);
//     vdl_assert_IndexOutOfBound(v, i);
...
//     vdl_e_Set(v, i + num_object, vdl_e_AddressOf(v, i), num_object);
//     // Copy in the new content
//     vdl_e_Set(v, i, object, num_object);
//     vdl_ReturnConst();
// }
...
// static inline vdl_vp vdl_ScalarEq_BT(vdl_fr bt, const vdl_vec *const v, void *const object)
// {
//     vdl_WithBT()
//     {
//         vdl_HealthCheck(v);
...
// static inline int vdl_ScalarIn_BT(vdl_fr bt, vdl_vec *const v, void *object)
// {
//     vdl_WithBT()
//     {
//         vdl_HealthCheck(v);
...
//         {
//             case VDL_TYPE_CHAR:
//                 vdl_For_i(vdl_Length(v)) if (vdl_e_GetChar(v, i) == vdl_char_Array(object)[0]) vdl_ReturnConst(1);
//                 break;
//             case VDL_TYPE_INT:
//                 vdl_For_i(vdl_Length(v)) if (vdl_e_GetInt(v, i) == vdl_int_Array(object)[0]) vdl_ReturnConst(1);
//                 break;
//             case VDL_TYPE_DOUBLE:
//                 vdl_For_i(vdl_Length(v)) if (vdl_e_GetDouble(v, i) == vdl_double_Array(object)[0]) vdl_ReturnConst(1);
//                 break;
//             case VDL_TYPE_VP:
//                 vdl_For_i(vdl_Length(v)) if (vdl_e_GetVp(v, i) == vdl_vp_Array(object)[0]) vdl_ReturnConst(1);
//         }
//         vdl_ReturnConst(0);
//     }
// }
//
// #define vdl_Copy(...) vdl_bt_Call(vdl_Copy_BT, __VA_ARGS__)
// static inline vdl_vp vdl_Copy_BT(vdl_fr bt, vdl_vec *v)
// {
//     vdl_WithBT()
//     {
